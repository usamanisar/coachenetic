...
import 'package:coach_netic/screens/coach_order.dart';
...
class CoachBottomBar extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey = new GlobalKey<ScaffoldState>();

  final User user;

  CoachBottomBar({this.user});

  @override
  _CoachBottomBarState createState() => _CoachBottomBarState();
}

class _CoachBottomBarState extends State<CoachBottomBar> {
  int _currentIndex = 0;
