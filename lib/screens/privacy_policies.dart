...
class Privacy_Policies extends StatefulWidget {
  @override
  _Privacy_PoliciesState createState() => _Privacy_PoliciesState();
}

class _Privacy_PoliciesState extends State<Privacy_Policies> {
